...
g++ -std=c++23 -Wall -Wextra -Werror -pipe -O3 -flto digest.cpp -Wl,--dynamic-linker=/lib/ld.so -o digest -lboost_program_options -lboost_filesystem -lboost_date_time -lboost_regex -lcrypto -llzma

MinGW64
http://nuwen.net/files/mingw/mingw-12.2.exe
http://slproweb.com/download/Win64OpenSSL-1_0_2.exe
http://www.microsoft.com/downloads/details.aspx?familyid=bd2a6171-e2d6-4230-b809-9a8d7548c1b6
g++ -std=c++23 -Wall -Wextra -Werror -pipe -O3 -flto digest.cpp -o digest -lboost_program_options -lboost_filesystem libeay32.dll
...
g++ -std=c++23 -Wall -Wextra -Werror -pipe -O3 -flto digest.cpp -o digest libboost_program_options-mgw47-mt-1_51.a libboost_filesystem-mgw47-mt-1_51.a libeay32.dll
